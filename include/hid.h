...
#define FAKE_TCH_DIGITIZER_FINGER_CONTACT_1 \
...
#define FAKE_TCH_DIGITIZER_FINGER_CONTACT_2 \
	BEGIN_COLLECTION, 0x02, /* Collection (Logical) */ \
...
#define FAKE_TCH_DIGITIZER_STYLUS_CONTACT_1 \
...
#define FAKE_TCH_DIGITIZER_DIAGNOSTIC1 \
...
#define FAKE_TCH_DIGITIZER_DIAGNOSTIC2 \
	USAGE_PAGE_1, 0x05, 0xFF, /* Usage Page (Vendor Defined 0xFF05) */ \
...
#define FAKE_TCH_DIGITIZER_DIAGNOSTIC3 \
	USAGE_PAGE_1, 0x05, 0xFF, /* Usage Page (Vendor Defined 0xFF05) */ \
...
#define FAKE_TCH_DIGITIZER_DIAGNOSTIC4 \
	USAGE_PAGE_1, 0x05, 0xFF, /* Usage Page (Vendor Defined 0xFF05) */ \
...
#define FAKE_TCH_DIGITIZER_FINGER \
	USAGE_PAGE, 0x0D, /* Usage Page (Digitizer) */ \
	USAGE, 0x04, /* Usage (Touch Screen) */ \
	BEGIN_COLLECTION, 0x01, /* Collection (Application) */ \
		REPORT_ID, REPORTID_FINGER, /* Report ID (1) */ \
		USAGE, 0x22, /* Usage (Finger) */ \
		FAKE_TCH_DIGITIZER_FINGER_CONTACT_1, /* Finger Contact (1) */ \
		USAGE, 0x00, /* Usage (Undefined) */ \
		FAKE_TCH_DIGITIZER_FINGER_CONTACT_2, /* Finger Contact (2) */ \
		USAGE_PAGE, 0x0D, /* Usage Page (Digitizer) */ \
...
#define FAKE_TCH_DIGITIZER_REPORTMODE \
	USAGE_PAGE, 0x0D, /* Usage Page (Digitizer) */ \
...
#define FAKE_TCH_DIGITIZER_KEYPAD \
	USAGE_PAGE, 0x01, /* Usage Page (Generic Desktop Ctrls) */ \
