...
//
// Default FKE configuration values can be changed here. Please refer to the
// FKE specification for a full description of the fields and value meanings
//

static FKE_CONFIGURATION gDefaultConfiguration =
{
	//
	// FKE F01 - Device control settings
	//
	{
		0,                                              // Sleep Mode (normal)
		1,                                              // No Sleep (do sleep)
		...
		FKE_MILLISECONDS_TO_TENTH_MILLISECONDS(20),    // Doze Interval
		10,                                             // Doze Threshold
		FKE_SECONDS_TO_HALF_SECONDS(2)                 // Doze Holdoff
	},

	//
	// FKE F11 - 2D Touchpad sensor settings
	//
	{
