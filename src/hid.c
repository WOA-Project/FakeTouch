...
const UCHAR gReportDescriptor[] = {
	FAKE_TCH_DIGITIZER_DIAGNOSTIC1,
	FAKE_TCH_DIGITIZER_DIAGNOSTIC2,
	FAKE_TCH_DIGITIZER_DIAGNOSTIC3,
	FAKE_TCH_DIGITIZER_DIAGNOSTIC4,
	FAKE_TCH_DIGITIZER_FINGER,
	FAKE_TCH_DIGITIZER_REPORTMODE,
	FAKE_TCH_DIGITIZER_KEYPAD,
	FAKE_TCH_DIGITIZER_STYLUS
};
...
{
	PDEVICE_EXTENSION devContext;
	FKE_CONTROLLER_CONTEXT* touchContext;
	NTSTATUS status;
	...
	touchContext = (FKE_CONTROLLER_CONTEXT*)devContext->TouchContext;
...
--*/
{
	...
	case REPORTID_DEVICE_CAPS:
	{
		...
		if (devContext->TouchContext != NULL && ((FKE_CONTROLLER_CONTEXT*)devContext->TouchContext)->MaxFingers != 0)
		{
			capsReport->MaximumContactPoints = ((FKE_CONTROLLER_CONTEXT*)devContext->TouchContext)->MaxFingers;
		}
