...
/*++
  ...
  Routine Description:
	...
	level-triggered interrupts when using Fake 3202.
...
*/
{
	...
	//
	// N.B. This FKE chip's IRQ is level-triggered, but cannot be enabled in
...
--*/
{
	...
	//
	// Configure the timer for continuous simulation on fake hardware that doesn't support it
	//
